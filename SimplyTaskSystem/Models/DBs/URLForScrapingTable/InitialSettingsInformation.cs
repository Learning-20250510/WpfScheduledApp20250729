...
namespace SimplyTaskSystem.Models.DBs.URLForScrapingTable
{
    class InitialSettingsInformation
    {
        ...
        public void CreateURLForScrapingTable()
        {
            CommonDBsUtility cDBu = new CommonDBsUtility();
            string createTableSql = "create table if not exists simpletasksystem.urlforscraping(id INT AUTO_INCREMENT NOT NULL PRIMARY KEY, url LONGTEXT NOT NULL UNIQUE, created_at DATETIME NOT NULL DEFAULT current_timestamp)";
