...
namespace SimplyTaskSystem.Models.DBs.TemporaryForAutoCreateMMFilesTable
{
    class InitialSettingsInformation
    {
        ...
        public void CreateTFACMMFTable()
        {
