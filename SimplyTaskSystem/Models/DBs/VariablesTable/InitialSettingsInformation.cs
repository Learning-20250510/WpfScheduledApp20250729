...
namespace SimplyTaskSystem.Models.DBs.VariablesTable
{
    class InitialSettingsInformation
    {
        ...
        public void CreateVariablesTable()
        {
            ...
            string createTableSql = "create table if not exists simpletasksystem.variables(id INT AUTO_INCREMENT NOT NULL PRIMARY KEY, name LONGTEXT NOT NULL UNIQUE, created_at DATETIME NOT NULL DEFAULT current_timestamp)";
