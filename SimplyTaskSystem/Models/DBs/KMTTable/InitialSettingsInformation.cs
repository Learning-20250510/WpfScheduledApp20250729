...
namespace SimplyTaskSystem.Models.DBs.KMTTable
{
    class InitialSettingsInformation
    {
        ...
        public void CreateKMTTable()
        {
            CommonDBsUtility cDBu = new CommonDBsUtility();
            string createTableSql = "create table if not exists simpletasksystem.kmt(id INT AUTO_INCREMENT NOT NULL PRIMARY KEY, kmt VARCHAR(200) NOT NULL UNIQUE, created_at DATETIME NOT NULL DEFAULT current_timestamp)";
