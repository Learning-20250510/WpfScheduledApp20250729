...
namespace SimplyTaskSystem.Models.DBs.PeriodicallyCyclesTable
{
    class InitialSettingsInformation
    {
        ...
        public void CreatePCTable()
        {
            ...
            string createTableSql = "create table if not exists simpletasksystem.periodicallycycles(id INT AUTO_INCREMENT NOT NULL PRIMARY KEY, pc VARCHAR(200) NOT NULL UNIQUE, created_at DATETIME NOT NULL DEFAULT current_timestamp)";
