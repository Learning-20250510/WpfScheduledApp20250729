...
namespace SimplyTaskSystem.Models.DBs.SpecificRangeTable
{
    class InitialSettingsInformation
    {
        ...
        public void CreateSpecificRangeTable()
        {
            CommonDBsUtility cDBu = new CommonDBsUtility();
            string createTableSql = "create table if not exists simpletasksystem.SpecificRange(id INT AUTO_INCREMENT NOT NULL PRIMARY KEY, taskstable_id INT NOT NULL UNIQUE, category VARCHAR(200) NOT NULL, created_at DATETIME NOT NULL DEFAULT current_timestamp)";
