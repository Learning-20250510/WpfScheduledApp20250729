...
namespace SimplyTaskSystem.Models.DBs.WebPageTable
{
    class InitialSettingsInformation
    {
        ...
        public void CreateWebPageTable()
        {
            ...
            string createTableSql = "create table if not exists simpletasksystem.webpage(id INT AUTO_INCREMENT NOT NULL PRIMARY KEY, url LONGTEXT NOT NULL UNIQUE, created_at DATETIME NOT NULL DEFAULT current_timestamp)";
