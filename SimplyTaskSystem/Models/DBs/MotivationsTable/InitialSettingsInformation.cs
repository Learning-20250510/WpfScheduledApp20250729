...
namespace SimplyTaskSystem.Models.DBs.MotivationsTable
{
    class InitialSettingsInformation
    {
        ...
        public void CreateMotivationsTable()
        {
            CommonDBsUtility cDBu = new CommonDBsUtility();
            string createTableSql = "create table if not exists simpletasksystem.motivations(id INT AUTO_INCREMENT NOT NULL PRIMARY KEY, motivation_name VARCHAR(200) NOT NULL, created_at DATETIME NOT NULL DEFAULT current_timestamp)";
